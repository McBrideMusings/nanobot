<!-- Migrated to GitHub Issues on 2026-02-17. See https://github.com/McBrideMusings/nanobot/issues/19 -->
---
title: Phase 3a — Replies & Reactions
status: backlog
priority: medium
tags:
  - chat-app
...
- **Floating menu**: emoji reaction bar with 6 quick-pick emojis (👍👎❤️😂🔥👀) + Reply and Copy actions

### Reply Compose Bar

- Appears above input field when replying
- Shows: "Replying to [user/nanobot]: [preview text]" + dismiss (×) button
...
Prototype lines 333–418, 503–536
